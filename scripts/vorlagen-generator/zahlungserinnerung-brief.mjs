...
const BODY_PARAGRAPHS = [
  ...
  "die oben genannte Rechnung über [Betrag] € ist bisher noch nicht auf unserem Konto eingegangen. Die Zahlung sollte gemäß Rechnung bis zum [Datum] erfolgen.",
  "Wir gehen davon aus, dass es sich hierbei um ein Versehen handelt, und fügen diesem Schreiben eine Kopie der Rechnung bei.",
  "Wir bitten Sie, den offenen Betrag bis spätestens [Datum] ohne weitere Aufforderung zu begleichen.",
...
export async function generateZahlungserinnerungBrief() {
  const pdf = buildPdf();
