...
export const meta = {
  ...
  bildCredit: "Das Ohr, Wikimedia Commons, CC BY-SA 3.0",
  bildCreditHref: "https://creativecommons.org/licenses/by-sa/3.0/deed.de",
  kennwerte: [
...
- **Drechsel- und Schnitzzunst**: Dank der hohen Dichte lassen sich feinste Details ohne Ausbrüche ausarbeiten.
