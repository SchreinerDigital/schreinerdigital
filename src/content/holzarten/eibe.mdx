...
Wegen der hohen Dichte sollten Sägeblätter und Hobelmesser stets scharf gehalten werden, da stumpfes Werkzeug schnell zu Ausrissen statt der typischen spiegelglatten Oberfläche führt. Für den Feinschliff empfiehlt sich ein Aufbau über mehrere Körnungsstufen, bevor mit Öl oder Schellack poliert wird, um den natürlichen Glanz voll zur Geltung zu bringen. Auch kleine Reststücke lohnt es aufzuheben – für Drechsel- und Intarsienarbeiten ist selbst kleinformatiges Eibenholz begehrt.
