...
export const meta = {
  ...
  bild: "/verbindungstechnik/exzenterverbinder.jpg",
  kennwerte: [
...
Als moderne Weiterentwicklung haben sich flache, hebelbetätigte Steckverbinder wie das Lamello-Clamex-System etabliert (Bildbeispiel oben): Statt einer runden Sacklochbohrung genügt hier die ovale Nut eines gewöhnlichen Flachdübel-/Lamello-Fräsers – dieselbe Nut also, die auch für normale Flachdübelverbindungen entsteht. Zwei ineinandergreifende Kunststoffgehäuse werden in die gegenüberliegenden Nuten geklebt oder geschraubt; ein innenliegender Hebel wird nach dem Zusammenstecken umgelegt und verspannt die Bauteile formschlüssig – dasselbe Wirkprinzip wie beim klassischen Rundexzenter, nur ohne separate Bohrschablone und mit einer im Möbel praktisch unsichtbaren, sehr flachen Bauform.
