...
export const meta = {
  ...
  norm: "EN 14755",
  summary: "Im Strangpressverfahren hergestellte Leichtplatte mit durchgehenden Längsröhren – kaum tragfähig, aber leicht und günstig. Klassische Mittellage für stumpf einliegende Innentüren.",
  bild: "/plattenwerkstoffe/roehrenspanplatte.jpg",
  kennwerte: [
