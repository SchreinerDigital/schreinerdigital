...
import type { HolzartMeta } from "@/types/content";

export const metadata: Metadata = {
  title: "Holzarten",
  description:
    "Steckbriefe zu über 40 Massivhölzern: Herkunft, Holzbild, Eigenschaften, Verwendung, Praxistipps und technische Kennwerte.",
};
