...
export async function generateMetadata({
  ...
  if (!entry) return {};
  return {
    title: `${entry.meta.title} – Aufbau & Verarbeitung`,
...
export default async function PlattenwerkstoffPage({
  ...
  const related = await getRelatedEntries("plattenwerkstoffe", meta, "kategorie");
  ...
  return (
    <Container className="py-12 sm:py-16">
      ...
      <RelatedPages basePath="/plattenwerkstoffe" heading="Weitere Plattenwerkstoffe" items={related} />
    </Container>
  );
}
