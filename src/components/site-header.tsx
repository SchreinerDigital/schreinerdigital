...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/maschinen-werkzeuge", label: "Maschinen & Werkzeuge" },
      { href: "/tueren-abc", label: "Türenwissen" },
    ],
  },
  {
    id: "digitalisierung",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/betrieb-und-recht/zeitmanagement", label: "Arbeitszeiterfassung" },
      { href: "/betrieb-und-recht/mahnverfahren-inkasso-klage", label: "Mahnverfahren & Inkasso" },
      { href: "/betrieb-und-recht/arbeitsvorbereitung", label: "Arbeitsvorbereitung" },
      { href: "/betrieb-und-recht/lagerverwaltung-materialfluss", label: "Lagerverwaltung" },
      { href: "/betrieb-und-recht/qualitaetsmanagement", label: "Qualitätsmanagement" },
      { href: "/betrieb-und-recht/preisgestaltung-wirtschaftlichkeit", label: "Preisgestaltung" },
      { href: "/betrieb-und-recht/kundenkommunikation", label: "Kundenkommunikation" },
      { href: "/betrieb-und-recht/marketing", label: "Marketing" },
    ],
  },
  {
    id: "downloads",
