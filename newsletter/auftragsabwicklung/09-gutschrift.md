---
Serie: Auftragsabwicklung für Schreinereien (9/10)
Betreff: Gutschrift – das Wort, das im Handwerk fast immer falsch benutzt wird
Preheader: Was du meinst, wenn du "Gutschrift" sagst, ist steuerlich etwas ganz anderes als das, was das Gesetz darunter versteht.
Verwandte Vorlage: Gutschrift (/vorlagen)
---

# Die Gutschrift: ein Begriff, zwei völlig verschiedene Bedeutungen

Ein Kunde bekommt nachträglich einen Preisnachlass, weil eine Leistung nicht wie vereinbart erbracht wurde. Die naheliegende Bezeichnung dafür: "Gutschrift". Steuerrechtlich ist das aber missverständlich – und der Grund dafür überrascht die meisten.

## Zwei Bedeutungen, ein Wort

**Die kaufmännische Gutschrift** ist das, was die meisten meinen: eine nachträgliche Korrektur oder ein Preisnachlass zugunsten des Kunden, zum Beispiel bei einer Reklamation oder einer stornierten Teilleistung. Das ist die Bedeutung, um die es in dieser Ausgabe geht.

**Die umsatzsteuerliche Gutschrift** nach § 14 Abs. 2 Satz 2 UStG meint dagegen etwas komplett anderes: eine Abrechnung, bei der nicht du als leistender Unternehmer, sondern **der Leistungsempfänger selbst** die Rechnung erstellt – üblich zum Beispiel bei Provisionsabrechnungen oder in bestimmten Vertriebsstrukturen. Für eine typische Schreinerei kommt diese Konstellation praktisch nie vor.
...
*Alle Angaben ohne Gewähr und keine Steuerberatung im Einzelfall.*
